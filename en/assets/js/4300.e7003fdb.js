(self["webpackChunkeosio_lacchain_net"] = self["webpackChunkeosio_lacchain_net"] || []).push([[4300],{
...
function resolve_iterableToArray(iter) { if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter); }
...
function postResolve(responses, sources) {
  return sources.map(function (source) {
    ...
    invariant(Array.isArray(items), "The `getItems` function from source \"".concat(source.sourceId, "\" must return an array of items but returned type ").concat(JSON.stringify(resolve_typeof(items)), ":\n\n").concat(JSON.stringify(items, null, 2), ".\n\nSee: https://www.algolia.com/doc/ui-libraries/autocomplete/core-concepts/sources/#param-getitems"));
...
var version_version = '3.0.0-alpha.37';
  ...
  var autocomplete = react.useMemo(function () {
    return createAutocomplete({
      ...
      getSources: function getSources(_ref3) {
        ...
        return searchClient.initIndex(indexName).search(query, DocSearchModal_objectSpread({
