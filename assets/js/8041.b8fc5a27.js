"use strict";
(self["webpackChunkeosio_lacchain_net"] = self["webpackChunkeosio_lacchain_net"] || []).push([[8041],{
...
function Translate(_ref3){var children=_ref3.children,id=_ref3.id,values=_ref3.values;var _a;if(typeof children!=='string'){console.warn('Illegal <Translate> children',children);throw new Error('The Docusaurus <Translate> component only accept simple string values');}var localizedMessage=(_a=getLocalizedMessage({message:children,id:id}))!==null&&_a!==void 0?_a:children;return/*#__PURE__*/react.createElement(Interpolate,{values:values},localizedMessage);}
...
/* harmony import */ var _docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3018);
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "D9": function() { return /* reexport */ usePrevious_usePrevious; },
  "LU": function() { return /* reexport */ useThemeConfig; },
  "pe": function() { return /* reexport */ useTitleFormatter; }
});

// UNUSED EXPORTS: isDocsPluginEnabled, useLocalPathname, useLocationChange, useMobileSecondaryMenuRenderer
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function usePrevious_usePrevious(value){var ref=(0,react.useRef)();(0,react.useEffect)(function(){ref.current=value;});return ref.current;}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function useLocationChange(onLocationChange){var location=useLocation();var previousLocation=usePrevious(location);var isFirst=useRef(true);useEffect(function(){// Prevent first effect to trigger the listener on mount
if(isFirst.current){isFirst.current=false;return;}onLocationChange({location:location,previousLocation:previousLocation});},[location]);}
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/objectWithoutPropertiesLoose.js
var objectWithoutPropertiesLoose = __webpack_require__(3366);
// EXTERNAL MODULE: ./node_modules/@docusaurus/core/lib/client/exports/ExecutionEnvironment.js
var ExecutionEnvironment = __webpack_require__(412);
...
ref:collapsibleRef,style:disableSSRStyle?undefined:getSSRStyle(collapsed),onTransitionEnd:function onTransitionEnd(e){if(e.propertyName!=='height'){return;}var el=collapsibleRef.current;var currentCollapsibleElementHeight=el.style.height;if(!collapsed&&parseInt(currentCollapsibleElementHeight,10)===el.scrollHeight){applyCollapsedStyle(el,false);onCollapseTransitionEnd===null||onCollapseTransitionEnd===void 0?void 0:onCollapseTransitionEnd(false);}if(currentCollapsibleElementHeight===CollapsedStyles.height){applyCollapsedStyle(el,true);onCollapseTransitionEnd===null||onCollapseTransitionEnd===void 0?void 0:onCollapseTransitionEnd(true);}},className:className},children);}function CollapsibleLazy(_ref4){var collapsed=_ref4.collapsed,props=(0,objectWithoutPropertiesLoose/* default */.Z)(_ref4,_excluded);var _useState2=(0,react.useState)(!collapsed),mounted=_useState2[0],setMounted=_useState2[1];(0,react.useLayoutEffect)(function(){if(!collapsed){setMounted(true);}},[collapsed]);// lazyCollapsed updated in effect so that the first expansion transition can work
...
/* harmony default export */ var styles_module = ({"details":"details_2Ziz","isClient":"isClient_1Fil","collapsibleContent":"collapsibleContent_3OHp"});
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function isInSummary(node){if(!node){return false;}return node.tagName==='SUMMARY'||isInSummary(node.parentElement);}function hasParent(node,parent){if(!node){return false;}return node===parent||hasParent(node.parentElement,parent);}var Details=function Details(_ref){var _clsx;var summary=_ref.summary,children=_ref.children,props=(0,objectWithoutPropertiesLoose/* default */.Z)(_ref,Details_excluded);var _useDocusaurusContext=(0,exports_useDocusaurusContext/* default */.Z)(),isClient=_useDocusaurusContext.isClient;var detailsRef=(0,react.useRef)(null);var _useCollapsible=useCollapsible({initialState:!props.open}),collapsed=_useCollapsible.collapsed,setCollapsed=_useCollapsible.setCollapsed;// We use a separate prop because it must be set only after animation completes
// Otherwise close anim won't work
var _useState=(0,react.useState)(props.open),open=_useState[0],setOpen=_useState[1];return/*#__PURE__*/react.createElement("details",Object.assign({},props,{ref:detailsRef,open:open,"data-collapsed":collapsed,className:(0,clsx_m/* default */.Z)(styles_module.details,(_clsx={},_clsx[styles_module.isClient]=isClient,_clsx),props.className),onMouseDown:function onMouseDown(e){var target=e.target;// Prevent a double-click to highlight summary text
